...
_USERPAPMINUTESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='minutes', full_name='grpc_testauth.user.UserPapMinutesResponse.minutes', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
UserServiceSearchRequest = _reflection.GeneratedProtocolMessageType('UserServiceSearchRequest', (_message.Message,), {
...
UserSearchResponse = _reflection.GeneratedProtocolMessageType('UserSearchResponse', (_message.Message,), {
...
UserPapMinutesRequest = _reflection.GeneratedProtocolMessageType('UserPapMinutesRequest', (_message.Message,), {
...
UserPapMinutesResponse = _reflection.GeneratedProtocolMessageType('UserPapMinutesResponse', (_message.Message,), {
